...
var config = {
	"shim": {
		"themevast/custommenu": ["jquery"]
	},
	'paths': {
		'themevast/custommenu': 'Themevast_CustomMenu/js/custommenu'
    }
};
...
var config = {
	"shim": {
		"themevast/datetime": ["jquery"]
	},
	'paths': {
		'themevast/datetime': 'Themevast_HotDeals/js/dailydate'
    }
};
...
var config = {
    map: {
        '*': {
        	'themevast/timer': 'Themevast_PriceCountdown/js',
        },
    }
};
