				  ...
				  <tr>
                        <td>
							<?php
								...
								$hidden = array('content_type' => 'Box');
								$fetchData=($localData)?json_decode($localData->json_content):NULL;
								// Form Open
							...
							?>
								<div class="col-sm-12">
										<div class="form-group">
											...
											if(isset($fetchData) && $fetchData->title !="") { echo $fetchData->title ; }?>">
										</div>
								</div>
                                <div class="col-sm-12">								
									<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<textarea class="form-control required" name="content" id="content"><?php 
											if(isset($fetchData) && $fetchData->content !="") { echo $fetchData->content ; }?></textarea>
									</div>
								</div>
								<?php
