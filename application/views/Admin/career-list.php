<div class="page-wrapper">
            <div class="content container-fluid">
			   ...
			   $form_attribute=array(
				...
				// Form Open
				echo form_open('admin/career_list',$form_attribute,$hidden);
				?>						
                <div class="row filter-row">
                    ...
                    <div class="ml-3">
						...
						<button type="button" class="btn btn-danger" onclick="javascript:window.location.href='<?=base_url('admin/career_list')?>';"> Clear</button>
                    </div>					
                </div>
				<?php
					// Form Close
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="<?=$class?>">
									   ...
									   <td><?=$postsList->post_slug?></td>
                                        ...
                                        <td><?=($postsList->cat_name)?$postsList->cat_name:'-'?></td> <td>
										<div class="dropdown action-label">
											...
											?>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="<?=base_url('admin/career_status?do=pending&post_id='.$postsList->id)?>"><i class="fa fa-dot-circle-o text-warning"></i> Pending</a>
                                                    <a class="dropdown-item" href="<?=base_url('admin/career_status?do=publish&post_id='.$postsList->id)?>"><i class="fa fa-dot-circle-o text-success"></i> Publish</a>
													<a class="dropdown-item" href="<?=base_url('admin/career_status?do=draft&post_id='.$postsList->id)?>"><i class="fa fa-dot-circle-o text-danger"></i> Draft</a>
                                                </div>
												<?php } ?>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-right">
										<?php
										if (getUserCan('career_module', 'access_write') || getUserCan('career_module', 'access_delete')) {
										?>
                    ...
                    <div class="modal-body">
						<div class="m-b-30">
                             <?php
									...
									$hidden = array('action' => 'addCareer');
									// Form Open
									echo form_open_multipart('admin/add_career',$form_attribute,$hidden);
								?>
							<div class="row">
							  <div class="col-sm-6">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Linkedin URL <span class="text-danger">*</span></label>
									<input class="form-control required" type="url" name="linkedin" id="linkedin">
								</div>
							 </div>
							  <div class="col-sm-6">
							  <div class="form-group">
							  ...
							  <div class="col-sm-6">
							     <div class="form-group">
									<label class="display-block control-label">Career Status <span class="text-danger">*</span></label>
							  ...
							  <div class="col-sm-12">
								...
								<div class="form-group">
									...
									<textarea class="form-control required" name="post_short_content" id="post_short_content"></textarea>
									<label for="post_short_content" generated="true" id="ckeditor-msg"></label>
								</div>
								<div class="form-group">
									<label class="control-label">Global Marketing Content <span class="text-danger">*</span></label>
								...
								<div class="form-group">
									<label class="control-label">Preferred Qualifications Content <span class="text-danger">*</span></label>
									<textarea class="form-control required text-editor" name="post_quali_content" id="post_quali_content"></textarea>
									<label for="post_quali_content" generated="true" id="ckeditor-msg2"></label>
								</div>
                                <div class="col-sm-7">								
									<div class="m-t-20">
										<button class="btn btn-primary btn-lg" type="submit">Create Career</button>
									</div>
								</div>
                            <?php
							// Form Close
                    ...
                    <div class="modal-body">
                        <div class="m-b-30">
                            <?php
								...
								$hidden = array('action' => 'editCareer','id'=>'');
								// Form Open
								echo form_open_multipart('admin/add_career',$form_attribute,$hidden);
								?>
							<div class="row">
							  <div class="col-sm-6">
								...
								<div class="col-md-6">
								<div class="form-group">
									<label class="display-block">Career Status <span class="text-danger">*</span></label>
									<div class="form-check form-check-inline">
								...
								<div class="form-group">
									...
									<textarea class="form-control required" name="post_short_content" id="edit_post_short_content"></textarea>
									<label for="post_short_content" generated="true"></label>
								</div>
								<div class="form-group">
									<label class="control-label">Global Marketing Content <span class="text-danger">*</span></label>
									<textarea class="form-control required text-editor" name="post_long_content" id="post_long_content"></textarea>
									<label for="post_long_content" generated="true" id="ckeditor-msg"></label>
								</div>
								<div class="form-group">
									<label class="control-label">Preferred Qualifications Content <span class="text-danger">*</span></label>
									<textarea class="form-control required text-editor" name="post_quali_content" id="post_quali_content"></textarea>
                ...
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body card-box">
					 <?php
						...
						$hidden = array('action' => 'deleteCareer','post_id'=>'');
						//Form Open
						echo form_open('admin/delete_career',$form_attribute,$hidden);
						?>
                        <p>Do you want to delete the career now with his related table data? This cannot be undone.</p>
...
function getEditData(post_id){
	...
	$("#ckeditor-msg").html("");
	$("#ckeditor-msg2").html("");
	var dataString="request=edit_career_data&post_id="+post_id;
	//alert(dataString);
	//return false;
	jQuery.ajax({
		type: "POST",
		...
		success: function(res) {
			...
			if (res.dataContent)
			{
				if(res.dataContent != ''){
					...
					$("form[name=edit-post] #linkedin").val(res.dataContent.linkedin);
					$("form[name=edit-post] #edit_post_short_content").val(res.dataContent.post_short_content);
					CKEDITOR.instances['post_long_content'].setData(res.dataContent.post_long_content);
					CKEDITOR.instances['post_quali_content'].setData(res.dataContent.post_quali_content);
...
function getAllCategoriesData(post_id){
	var dataString="request=get-all-categories&type=CA&id="+post_id;
