<style>
	...
	.preview-mimages-zone>.preview-image {
		height: 90px;
		width: 90px;
		position: relative;
		margin-right: 5px;
	...
	.preview-mimages-zone>.preview-image>.image-zone {
		width: 100%;
		height: 100%;
	}

	.preview-images-zone>.preview-image>.image-zone>img,
	.preview-mimages-zone>.preview-image>.image-zone>img {
		width: 100%;
		height: 100%;
	}

	.preview-images-zone>.preview-image>.tools-edit-image,
	.preview-mimages-zone>.preview-image>.tools-edit-image {
		position: absolute;
		z-index: 100;
		color: #fff;
		bottom: 0;
	...
	.preview-mimages-zone>.preview-image>.mimage-cancel {
		font-size: 18px;
		position: absolute;
		top: 0;
		right: 0;
	...
	.preview-mimage:hover>.image-zone {
		cursor: pointer;
		opacity: .5;
	}
	...
	.preview-mimage:hover>.tools-edit-image,
	...
	<div class="content container-fluid">
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-8">
							<h2>Trusted By Over <b>500+</b> Companies Worldwide</h2>
						</div>
					</div>
				</div>
				<div id="tMsg-2"></div>
				...
				?>
					<fieldset class="form-group">
						<a href="javascript:void(0)" class="btn btn-primary btn-rounded add-new-trust" onclick="$('#pro-image').click()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-upload" viewBox="0 0 16 16">
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<?php $fetchData1 = ($TopMiddleContent) ? json_decode($TopMiddleContent->json_content) : NULL;
						$title1 = 'SIMPLE 3 STEP PROCESS';
						...
						<tr>
							<td>
								...
								$form_attribute = array(
									'name' => 'add-free-seo-audit-content',
									'class' => 'form-horizontal',
									'method' => "post",
									'id' => 'add-free-seo-audit-content',
									'novalidate' => 'novalidate',
								);
								$hidden = array('content_type' => 'TopMiddleContent');
								// Form Open
								echo form_open_multipart('admin/add_free_seo_audit_content', $form_attribute, $hidden);
								?>
								<div class="col-sm-12">
					...
					<tbody>
						<tr>
							<td>
								...
								$hidden = array('content_type' => 'LeftContent');
								$fetchData2 = ($LeftContent) ? json_decode($LeftContent->json_content) : NULL;
								// Form Open
								echo form_open_multipart('admin/add_free_seo_audit_content', $form_attribute, $hidden);
								?>
								<div class="col-sm-12">
									<div class="form-group">
										<label>Title <span class="text-danger">*</span></label>
										<input class="form-control required" type="text" name="title" id="title" value="<?php
										if (isset($fetchData2) && $fetchData2->title != "") {
											echo $fetchData2->title;
										} ?>">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										...
										if (isset($fetchData2) && $fetchData2->image != "") {
											$bannerfilename = 'uploads/free_seo_audit_images/' . $fetchData2->image;
											if (file_exists($bannerfilename)) {
												$banner_file = '../uploads/free_seo_audit_images/' . $fetchData2->image;
											}
										?>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label>Content<span class="text-danger"></span></label>
										<textarea class="form-control required" name="content" id="content"><?php
										if (isset($fetchData2) && $fetchData2->content != "") {
											echo $fetchData2->content;
										} ?></textarea>
									</div>
								</div>
								<?php
							...
							<td>
								...
								$hidden = array('content_type' => 'MiddleContent');
								$fetchData3 = ($MiddleContent) ? json_decode($MiddleContent->json_content) : NULL;
								// Form Open
								echo form_open_multipart('admin/add_free_seo_audit_content', $form_attribute, $hidden);
								?>
								<div class="col-sm-12">
									<div class="form-group">
										<label>Title <span class="text-danger">*</span></label>
										<input class="form-control required" type="text" name="title" id="title" value="<?php
										if (isset($fetchData3) && $fetchData3->title != "") {
											echo $fetchData3->title;
										} ?>">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										...
										if (isset($fetchData3) && $fetchData3->image != "") {
											$bannerfilename = 'uploads/free_seo_audit_images/' . $fetchData3->image;
											if (file_exists($bannerfilename)) {
												$banner_file = '../uploads/free_seo_audit_images/' . $fetchData3->image;
											}
										?>
											<a href="<?= isset($banner_file) ? $banner_file : '' ?>">
												<img src="<?= isset($banner_file) ? $banner_file : '' ?>" class="img-thumbnail" />
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label>Content<span class="text-danger"></span></label>
										<textarea class="form-control required" name="content" id="content"><?php
										if (isset($fetchData3) && $fetchData3->content != "") {
											echo $fetchData3->content;
										} ?></textarea>
									</div>
								</div>
								<?php
							...
							<td>
								...
								$hidden = array('content_type' => 'RightContent');
								$fetchData4 = ($RightContent) ? json_decode($RightContent->json_content) : NULL;
								// Form Open
								echo form_open_multipart('admin/add_free_seo_audit_content', $form_attribute, $hidden);
								?>
								<div class="col-sm-12">
									<div class="form-group">
										<label>Title <span class="text-danger">*</span></label>
										<input class="form-control required" type="text" name="title" id="title" value="<?php
										if (isset($fetchData4) && $fetchData4->title != "") {
											echo $fetchData4->title;
										} ?>">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										...
										if (isset($fetchData4) && $fetchData4->image != "") {
											$bannerfilename = 'uploads/free_seo_audit_images/' . $fetchData4->image;
											if (file_exists($bannerfilename)) {
												$banner_file = '../uploads/free_seo_audit_images/' . $fetchData4->image;
											}
										?>
											<a href="<?= isset($banner_file) ? $banner_file : '' ?>">
												<img src="<?= isset($banner_file) ? $banner_file : '' ?>" class="img-thumbnail" />
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label>Content<span class="text-danger"></span></label>
										<textarea class="form-control required" name="content" id="content"><?php
										if (isset($fetchData4) && $fetchData4->content != "") {
											echo $fetchData4->content;
										} ?></textarea>
									</div>
								</div>
								<?php
...
<script>
			...
			$.confirm({
				...
				buttons: {
					confirm: function() {
						...
						var dataString = "requestType=Trusted&pid=" + <?php echo FREE_SEO_AUDIT_PAGE_ID; ?> + "&deleteId=" + deleteImage;
						$.ajax({
							type: "POST",
	...
	function readImage() {
		if (window.File && window.FileList && window.FileReader) {
			...
			if (isValidExt) {
				...
				formdata.append("pid", <?php echo FREE_SEO_AUDIT_PAGE_ID; ?>);
	...
	function load_trusted_data() {
		var dataString = "requestType=Trusted&pid=" + <?php echo FREE_SEO_AUDIT_PAGE_ID; ?>;
