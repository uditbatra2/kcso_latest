                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <?php
								...
								$hidden = array('action' => 'emailsUser');
								//Form Open
								echo form_open_multipart('admin/emails_list',$form_attribute,$hidden);
								?>
                                <div class="form-group">
									<label>To <span class="text-danger">*</span></label>
									<select class="select required" name="to[]" id="to" multiple>
										<?php foreach($userListData as $userListData){?>
										<option value="<?=$userListData->email_id?>"><?=$userListData->email_id?> (<?=$userListData->name?>)</option>
										<?php } ?>
									</select>
								</div>
                                <div class="form-group">
