<div class="page-wrapper">
            <div class="content container-fluid">
			   ...
			   $form_attribute=array(
				...
				// Form Open
				echo form_open('admin/testimonials_list',$form_attribute,$hidden);
				?>						
                <div class="row filter-row">
                    ...
                    <div class="ml-3">
						...
						<button type="button" class="btn btn-danger" onclick="javascript:window.location.href='<?=base_url('admin/testimonials_list')?>';"> Clear</button>
                    </div>					
                </div>
				<?php
					// Form Close
					echo form_close(); ?>
				<?php if($this->session->flashdata('testimonial_success')){ ?>
					<div class="alert alert-success">
						<a href="#" class="close" data-dismiss="alert">&times;</a>
						<strong>Success!</strong> <?php echo $this->session->flashdata('testimonial_success'); ?>
					</div>

				<?php }else if($this->session->flashdata('testimonial_error')){  ?>
					<div class="alert alert-danger">
						<a href="#" class="close" data-dismiss="alert">&times;</a>
						<strong>Error!</strong> <?php echo $this->session->flashdata('testimonial_error'); ?>
					</div>
				<?php }?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table datatable">
                                ...
                                <tbody>
									...
									$srno=1;
                                    $count = 0;
                                    foreach($testimonialList as $testimonialList){								
									$count++;
								    $class=($count % 2 == 1) ? " odd" : " even";
									?>
                                    <tr role="row" class="<?=$class?>">
									    <td><?=$srno?></td>
                                        <td><?=$testimonialList->author?></td>
										<td><?=$testimonialList->description?></td>
										 <td class="lightgallery">
											<?php
											$pagefilename = 'uploads/testimonial_images/'.$testimonialList->picture;
											...
											{
												$page_file='../uploads/testimonial_images/small/'.$testimonialList->picture;
                                                $page_original_file = '../uploads/testimonial_images/'.$testimonialList->picture;												
											}
											?>
                                         ...
                                         <td>
											<div class="dropdown action-label">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="<?=base_url('admin/testimonial_status?do=pending&testimonial_id='.$testimonialList->id)?>"><i class="fa fa-dot-circle-o text-warning"></i> Pending</a>
                                                    <a class="dropdown-item" href="<?=base_url('admin/testimonial_status?do=publish&testimonial_id='.$testimonialList->id)?>"><i class="fa fa-dot-circle-o text-success"></i> Publish</a>
													<a class="dropdown-item" href="<?=base_url('admin/testimonial_status?do=draft&testimonial_id='.$testimonialList->id)?>"><i class="fa fa-dot-circle-o text-danger"></i> Draft</a>
                                                </div>
												<?php } ?>
                                            </div>
                                        ...
                                        <td class="text-right">
										<?php
										if (getUserCan('testimonials_module', 'access_write') || getUserCan('testimonials_module', 'access_delete')) {
										?>
                    ...
                    <div class="modal-body">
						<div class="m-b-30">
							...
							<div class="row">
							  ...
							  <div class="col-sm-6">
								 <div class="form-group">
									<label class="control-label">Your Designation<span class="text-danger">*</span></label>
									<input class="form-control required" type="text" name="role" id="role">
								</div>
								</div>
								<div class="col-sm-6">
								<div class="form-group">
							  ...
							  <div class="col-sm-6">
							   <div class="form-group">
									<label class="control-label">Your Company<span class="text-danger">*</span></label>
									<input class="form-control required" type="text" name="organization" id="organization">
								</div>
							 </div>
							  <div class="col-sm-6">
							    <div class="form-group">
							  ...
							  <div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Your Company Logo <span class="text-danger">*</span></label>
									<div>
										<input class="form-control required" type="file" name="organization_logo" id="organization_logo">
										<small class="form-text text-muted">Max. file size: 50 MB. Allowed images: jpg, gif, png, svg.</small>
									</div>
								</div>
							 </div>
							 <div class="col-md-6">
									<div class="form-group">
										<label>Testimonial Type <span class="text-danger">*</span></label>
										<select class="select required" name="type[]" id="type" multiple>
										</select>
									</div>									
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Testimonial Order <span class="text-danger">*</span></label>
										<select class="order_display required" name="ordering[]" id="ordering" multiple>
										</select>
									</div>
 								</div>
							  ...
							  <div class="col-sm-12">
								...
								<div class="form-group">
									...
									<textarea class="form-control required text-editor" name="description" id="description"></textarea>
									<label for="description" generated="true" id="ckeditor-msg"></label>
								</div>
                                <div class="col-sm-7">								
									<div class="m-t-20">
										<button class="btn btn-primary btn-lg" type="submit">Create Testimonial</button>
									</div>
								</div>
                            <?php
							// Form Close
							...
							<div class="row">
							  ...
							  <div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Your Company Logo <span class="text-danger">*</span></label>
									<div>
										<input class="form-control" type="file" name="organization_logo" id="organization_logo">
										<small class="form-text text-muted">Max. file size: 50 MB. Allowed images: jpg, gif, png, svg.</small>
									</div>
									<div class="form-group">
										<label></label>
										<img id="organization_logo_file"/>
									</div>
								</div>						
							 </div>
							 <div class="col-md-6">
							  ...
							  <div class="col-sm-12">
								...
								<div class="form-group">
									<label class="control-label">Content <span class="text-danger">*</span></label>
									<textarea class="form-control required text-editor" name="description" id="edit_description"></textarea>
									<label for="description" generated="true" id="ckeditor-msg"></label>
								</div>
                ...
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body card-box">
					 <?php
						...
						$hidden = array('action' => 'deleteTestimonial','testimonial_id'=>'');
						//Form Open
						echo form_open('admin/delete_testimonial',$form_attribute,$hidden);
						?>
                        <p>Do you want to delete the testimonial now with his related table data? This cannot be undone.</p>
...
$('#add-testimonial').validate({
	...
	"ordering[]": {
		required: true,
		digits: true,
		checkTypeLength: "add-testimonial"
	 }
	 },
	messages: {
		'ordering[]': {digits:"Please enter numbers Only"}
            },
...
$('#edit-testimonial').validate({
	...
	"ordering[]": {
		required: true,
		digits: true,
		checkTypeLength: "edit-testimonial"
	 }
	 },
	messages: {
		'ordering[]': {digits:"Please enter numbers Only"}
...
function getEditData(testimonial_id){
	...
	validator.resetForm();
	$("#ckeditor-msg").html("");
	var dataString="request=edit_testimonial_data&testimonial_id="+testimonial_id;
	//alert(dataString);
	//return false;
	jQuery.ajax({
		type: "POST",
		...
		success: function(res) {
			...
			if (res.dataContent)
			{
				if(res.dataContent != ''){
					...
					$("form[name=edit-testimonial] #author").val(res.dataContent.author);
					$("form[name=edit-testimonial] #organization").val(res.dataContent.organization);
					$("form[name=edit-testimonial] #role").val(res.dataContent.role);
					//$("form[name=edit-page] #page_long_content").val(res.dataContent.page_long_content);
					CKEDITOR.instances['edit_description'].setData(res.dataContent.description);
					...
					{
						img_src='../uploads/testimonial_images/small/'+res.dataContent.picture;				
					}									
                    $('form[name=edit-testimonial] img#testimonial_image_file').prop('src', img_src);
                    img_src= 'uploads/no-image100x100.jpg';
					if (res.dataContent.organization_logo != '')
					{
						img_src='../uploads/testimonial_images/small/'+res.dataContent.organization_logo;				
					}									
                    $('form[name=edit-testimonial] img#organization_logo_file').prop('src', img_src);					
					console.log(res.dataContent);
...
$("body").on('click','.delete-testimonial',function(event) {
	...
	if(stringArrayId > 0){
		$("form[name=delete-testimonial] input[name='testimonial_id']").val(stringArrayId);
	}
	//alert(stringArrayId);	
});
function getAllPagesData(testimonial_id){
	var dataString="request=get-all-pages&type=T&id="+testimonial_id;
	//alert(dataString);
	//return false;
	jQuery.ajax({
		type: "POST",
		...
		success: function(res) {
			...
			{
				if(res.dataContent != ''){
					$("select[id^=type]").html('').html(res.dataContent);
					$("select[id^=ordering]").html('').html(res.dataContent1);				
					console.log(res.dataContent);
				}else if (res.dataContent == ''){
					console.log(res);
				}
...
function getAllCategoriesData(testimonial_id){
	var dataString="request=get-all-categories&type=T&id="+testimonial_id;
...
$("form[id=add-testimonial]").submit( function(e) {
